...
def print_todo_list(todos: list[dict]) -> None:
    ...
    for t in todos:
        ...
        table.add_row(done_text, str(t["id"]), title_text, pri_text, due_text, tags)
...
def print_todo_added(todo: dict) -> None:
    console.print(f"[green]✓ Added:[/green] #{todo['id']} {todo['title']}")


def print_todo_done(todo: dict) -> None:
